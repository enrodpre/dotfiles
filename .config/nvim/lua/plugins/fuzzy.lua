...
return {
  ...
  keys = {
    ...
    { "<leader>ff", fzflua.files,               desc = "[F]ind [F]iles", },
    { "<leader>fc", cwd_picker(fzflua.files),   desc = "[F]ind Files in [C]wd", },
    { "<leader>fg", fzflua.live_grep,           desc = "[F]ind [G]rep", },
    { "<leader>fh", fzflua.help_tags,           desc = "[F]ind [H]elp", },
    { "<leader>fb", fzflua.builtin,             desc = "[F]ind [B]uiltins", },
    { "<leader>fk", fzflua.keymaps,             desc = "[F]ind [K]eymaps", },
    ...
    { "<leader>ft", debug_object,               desc = "[G]o to [D]efinitions" },
    { "<leader>fd", test_debug,                 desc = "[G]o to [D]efinitions" },
  },
  opts = function()
