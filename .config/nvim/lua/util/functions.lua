...
function F.tbl_from_idx(tbl, idx)
  local steps = vim.split(idx, ".", { plain = true })
  local last_step = table.remove(steps, #steps)

  -- vim.print(steps)
  local current_step = tbl
