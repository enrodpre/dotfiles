...
FILE="$HOME/.config/polybar/custom/scripts/rofi/colors.rasi"
...
rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/polybar/custom/scripts/rofi/launcher.rasi
